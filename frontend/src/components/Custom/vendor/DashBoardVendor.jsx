              ...
              <div className="card-body p-4">
                <div className="d-flex align-items-center mb-3">
                  ...
                  <div className="stat-content">
                    ...
                    >
                      {vendorDashboardStats.totalVendors}
                    </h3>
                    <p
                      className="mb-0"
                ...
                <div className="d-flex align-items-center mb-3">
                  ...
                  <div className="stat-content">
                    <h3
                      ...
                      style={{ fontSize: "24px", fontWeight: "600" }}
                    >
                      ${vendorDashboardStats?.totalSales?._sum?.total_price ? vendorDashboardStats.totalSales._sum.total_price.toFixed(2) : "0.00"}
                ...
                <div className="d-flex align-items-center mb-3">
                  ...
                  <div className="stat-content">
                    <h3
                      ...
                      style={{ fontSize: "24px", fontWeight: "600" }}
                    >
                      {vendorDashboardStats.totalProducts}
                    </h3>
                    <p
                      className="mb-0"
                      style={{ fontSize: "16px", color: "#6c757d" }}
                ...
                <div className="d-flex align-items-center mb-3">
                  ...
                  <div className="stat-content">
                    <h3
                      ...
                      style={{ fontSize: "24px", fontWeight: "600" }}
                    >
                      {vendorDashboardStats.totalFoodItems || 0}
                    </h3>
                    <p
                      className="mb-0"
                      style={{ fontSize: "16px", color: "#6c757d" }}
                ...
                <div className="d-flex align-items-center mb-3">
                  ...
                  <div className="stat-content">
                    <h3
                      ...
                      style={{ fontSize: "24px", fontWeight: "600" }}
                    >
                      {vendorDashboardStats?.weeklyProgress?._sum?.calories_burned
                      ? vendorDashboardStats.weeklyProgress._sum.calories_burned.toFixed(2)
                      : "0.00"}
                ...
                <div className="d-flex align-items-center mb-3">
                  ...
                  <div className="stat-content">
                    <h3
                      ...
                      style={{ fontSize: "24px", fontWeight: "600" }}
                    >
                      {vendorDashboardStats.totalUserDietPrograms}
                    </h3>
                    <p
                      className="mb-0"
                      style={{ fontSize: "16px", color: "#6c757d" }}
                ...
                <div className="d-flex align-items-center mb-3">
                  ...
                  <div className="stat-content">
                    <h3
                      ...
                      style={{ fontSize: "24px", fontWeight: "600" }}
                    >
                      {vendorDashboardStats.totalUserWorkoutPrograms}
                    </h3>
                    <p
                      className="mb-0"
                      style={{ fontSize: "16px", color: "#6c757d" }}
          ...
          <div className="col-xl-3 col-xxl-4 col-md-6">
            <div className="card">
              ...
              <div className="card-body text-center">
                ...
                <Link
                  to="/dashboard/vendor/workoutplan"

          ...
          <div className="col-xl-9 col-xxl-8">
            <div className="card">
              <div className="card-header flex-wrap pb-0 border-0">
                ...
                <div className="d-flex me-3 me-sm-4 mb-2">
                  <svg
                    className="me-2 mt-1"
                    width={24}
                    height={24}
                  ...
                  <div>
                    <h4 className="fs-18 text-black font-w600 mb-0">50%</h4>
                ...
                <div className="d-flex me-3 me-sm-4 mb-2">
                  ...
                  <div>
                    <h4 className="fs-18 text-black font-w600 mb-0">30%</h4>
                ...
                <div className="d-flex me-3 me-sm-4 mb-2">
                  ...
                  <div>
                    <h4 className="fs-18 text-black font-w600 mb-0">20%</h4>
                    <span className="fs-12 text-black">Yoga</span>
                  </div>
                </div>
                <div className="dropdown mt-sm-0 mt-3 mb-0">
                  <button
                    type="button"
              ...
              <div className="card-body">
                <div className="media align-items-center border border-warning rounded p-3 mb-md-4 mb-3">
                  <div className="d-inline-block me-3 position-relative donut-chart-sale2">
                    <span
                      className="donut2"
                      data-peity='{ "fill": ["rgb(255, 148, 50)", "rgba(255, 255, 255, 1)"],   "innerRadius": 27, "radius": 10}'
                    >
                      6/8
                    </span>
                    <small className="text-primary">
                ...
                <div className="media align-items-center border border-info rounded p-3 mb-md-4 mb-3">
                  <div className="d-inline-block me-3 position-relative donut-chart-sale2">
                    <span
                      className="donut2"
                      data-peity='{ "fill": ["rgb(30, 167, 197)", "rgba(255, 255, 255, 1)"],   "innerRadius": 27, "radius": 10}'
                    >
                      2/8
                    </span>
                    <small className="text-primary">
                ...
                <div className="media align-items-center border border-secondary rounded p-3">
                  <div className="d-inline-block me-3 position-relative donut-chart-sale2">
                    <span
                      className="donut2"
                      data-peity='{ "fill": ["rgb(192, 70, 211)", "rgba(255, 255, 255, 1)"],   "innerRadius": 27, "radius": 10}'
                    >
                      2/9
                    </span>
                    <small className="text-primary">
          ...
          <div className="col-xl-12">
            <div className="card">
              <div className="card-header d-sm-flex d-block pb-0 border-0">
                ...
                <div className="card-action card-tabs mt-3 mt-sm-0 mt-3 mb-sm-0 mb-3 mt-sm-0 me-0 me-md-5">
                      ...
                      <div className="items">
                        <div className="d-sm-flex p-3 border border-light rounded">
                          <a href="ecom-product-detail.html">
                            <img
                              className="me-4 food-image rounded"
                          ...
                          <div>
                            <div className="d-flex align-items-center mb-2">
                              <img
                                ...
                                width={30}
                              />
                              <span className="fs-14 text-primary">Ilham</span>
                            </div>
                            ...
                            <ul>
                              ...
                              <li>
                                <i
                                  className="fa fa-star me-3 scale5 text-warning"
                                  aria-hidden="true"
                                />
                          ...
                          <div>
                            <div className="d-flex align-items-center mb-2">
                              <img
                                ...
                                width={30}
                              />
                              <span className="fs-14 text-primary">Andrew</span>
                            </div>
                            <h6 className="fs-16 mb-4">
                              <a
                                href="ecom-product-detail.html"
